...
abstract class Client extends ClientBase {
  core.String basePath = "/replicapool/v1beta1/projects/";
  ...
  PoolsResource_ get pools => new PoolsResource_(this);
  ReplicasResource_ get replicas => new ReplicasResource_(this);
